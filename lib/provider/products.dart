...
class Products with ChangeNotifier {
  ...
  */
  ...
  /// get all the products information from database and store it locally
  ...
  /// update product detail information in the database
  ...
  /// remove a product detail information from the database
